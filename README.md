# _Shipping Cost Calcualtor_

#### _A console application for calculating the cost to ship an item_

#### By _**Todd Walraven**_

## Description

_This Application has the user enter the dimensions of an object. The program determines the cost of shipping based upon the users inputs_
